			...
			<div class="web_login" id="web_login">
				...
				<div class="login-box">
					...
					<div class="login_form">
						...
						<form
							action="${pageContext.request.contextPath }/LoginUserServlet"
			...
			<div class="web_login">
				<form name="form2" id="regUser" accept-charset="utf-8"
					...
					<ul class="reg_form" id="reg-ul">
						<div id="userCue" class="cue">${mag }</div>
						...
						<li><label for="passwd2" class="input-tips2">确认密码：</label>
							<div class="inputOuter2">
								<input type="password" id="passwd2" name="repasswd"
						...
						<li><label for="qq" class="input-tips2">QQ：</label>
							<div class="inputOuter2">
								...
								<input type="text" id="qq" name="qqnum" maxlength="10"
									class="inputstyle2" />
							</div></li>
